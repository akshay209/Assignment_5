...
def output(request):
    ...
    table = open("C:/Users/aksha/PycharmProjects/Assignment5-master/Assignment5-master/project/app/templates/output1.html", "w")
    table.write(b)
    table.close()

    table = open("C:/Users/aksha/PycharmProjects/Assignment5-master/Assignment5-master/project/app/templates/output1.html", "a")
...
def down_file(request):
    with open('Pivot_Data.xlsx', 'rb') as model_excel1:
        result1 = model_excel1.read()
    response1 = HttpResponse(result1)
    response1['Content-Disposition'] = 'attachment; filename=Pivot_Table.xlsx'
    return response1
...
def transpose(request):
    ...
    return render(request, "output1.html", {"string": c})
